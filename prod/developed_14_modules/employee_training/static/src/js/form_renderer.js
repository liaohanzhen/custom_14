odoo.define('employee_training.FormRenderer', function (require) {
'use strict';
...
FormRenderer.include({
	_renderView: function () {
		...
		if ((self.state.model=='training.template' || self.state.model=='wiki.web.page.wizard') && this.$el.find("iframe").length>0){
