...
#         self.name = "{}-{} ({}) {}".format(self.project_id.name or "", self.task_id.name or "", self.resource_id.name, self.load_factor or "")
        for rec in self:
            rec.name = "{}-{} ({}) {}".format(rec.project_id.name or "", rec.task_id.name or "", rec.resource_id.name, rec.load_factor or "")
