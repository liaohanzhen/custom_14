...
#             )
            description = MailTemplates.with_context(lang=lang)._render_template(agreement.description, "agreement", agreement.ids, post_process=True)[agreement.id]
...
#             )
            parties = MailTemplates.with_context(lang=lang)._render_template(tools.html_sanitize(agreement.parties), "agreement", agreement.ids, post_process=True)
...
#             )
#             special_terms = MailTemplates.with_context(lang=lang)._render_template(tools.html_sanitize(agreement.special_terms), "agreement", agreement.ids, post_process=True)
            special_terms = MailTemplates.with_context(lang=lang)._render_template(agreement.special_terms, "agreement", agreement.ids, post_process=True)[agreement.id]
