...
class IrUiMenu(models.Model):
    ...
    menu_icon_data = fields.Binary('Menu Icon Image', compute="_compute_menu_icon", store=True, attachment=True)
    app_menu_id = fields.Many2one('ir.ui.menu', 'App Menu', compute="_compute_app_menu", store=True, readonly=True)
...
class XFDashboardPopularMenu(models.Model):
    ...
    menu_id = fields.Many2one('ir.ui.menu', string='Menu', required=True, readonly=True, ondelete='cascade')
