...
class res_partner(models.Model):
    """
    Re-write to add duplicates search features
    """
    ...
    def write(self, vals):
        ...
        for record in self:
            ...
            duplicate_partners_recordset = record._return_duplicated_records(fields_names="duplicate_fields_partner")
            if duplicate_partners_recordset:
                ...
                for duplicate in duplicate_partners_recordset:
                    ...
                    http_warning = _("Sorry, but someone is already registered with the same {}".format(
                                        duplicated_fields
                                    ))
    ...
    def open_duplicates(self):
        ...
        return {
            ...
            'domain': [('id', 'in', duplicates.ids + self.ids)],
