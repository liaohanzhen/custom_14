...
from ..xml.functions import NS_REGEX, Element
from ..xml.constants import CHART_NS, REL_NS, DRAWING_NS
...
from ..chart.shapes import GraphicalProperties
from ..chart.text import RichText
