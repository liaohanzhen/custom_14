...
class SaleReport(models.Model):
    ...
    holding_partner_id = fields.Many2one('res.partner', 'Holding Partner', readonly=True)
    orderer = fields.Char(string='Orderer', readonly=True)
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            partner.holding_partner_id as holding_partner_id,
            comm_partner.ref::text || ' ' || comm_partner.name::text as orderer,
        ...
        from_ = """
                sale_order_line l
                      ...
                      left join res_partner comm_partner on partner.commercial_partner_id = comm_partner.id
        ...
        groupby_ = """
            ...
            partner.holding_partner_id,
            comm_partner.ref::text || ' ' || comm_partner.name::text,
            l.discount,
            s.id %s
        """ % (groupby)
