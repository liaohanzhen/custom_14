...
odoo.define('theme_clarico_vega.theme_script', function(require) {
    ...
    sAnimations.registry.themeEvent = sAnimations.Class.extend({
        ...
        read_events: {
            ...
            'click .te_brd_ctg_h4': '_onBrandCategorySection',
        },
        start: function() {
        ...
        _onBrandCategorySection: function(){
            var ctg_ul = $('.te_brd_ctg_h4').siblings('.te_shop_brd_ctg_list');
             if (ctg_ul.hasClass("open_ul")) {
                ctg_ul.removeClass("open_ul");
                ctg_ul.siblings(".te_brd_ctg_h4").addClass('te_fa-plus');
                ctg_ul.toggle('slow');
            }
            else{
                ctg_ul.addClass("open_ul");
                ctg_ul.siblings(".te_brd_ctg_h4").removeClass('te_fa-plus');
                ctg_ul.toggle('slow');
            }
        },
