...
class IrAttachment(models.Model):
    ...
    def _prepare_description_attachment(self, xml):
        ...
        cfdi_source = xml.Complemento.xpath(
                    'tfd:TimbreFiscalDigital[1]', 
                    namespaces={'tfd': 'http://www.sat.gob.mx/TimbreFiscalDigital'}) if hasattr(xml, 'Complemento') else None
        cfdi = cfdi_source[0] if cfdi_source else None 
        data = {
